...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  },
  {
    ...
    keywords: ['claude', 'timezone'],
  },
  {
    fieldId: 'disableClaudeCloakMode',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.disable_claude_cloak_mode'),
    hintKey: L('sections.advanced.disable_claude_cloak_mode_desc'),
  ...
  },
  {
    ...
    sectionId: 'advanced',
    labelKey: L('sections.advanced.cloak_model_list'),
    hintKey: L('sections.advanced.cloak_model_list_desc'),
    yamlKeys: ['claude-code', 'disable-cloaking-model-list'],
    keywords: ['claude', 'cloak', 'models'],
  },
  ...
  {
    fieldId: 'codexDisableCodexCloaking',
    sectionId: 'advanced',
    ...
    keywords: ['codex', 'cloak'],
  },
  {
    fieldId: 'codexOptimizeMultiAgentV2',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.codex_optimize_multi_agent_v2'),
    hintKey: L('sections.advanced.codex_optimize_multi_agent_v2_desc'),
    yamlKeys: ['codex', 'optimize-multi-agent-v2'],
    keywords: ['codex', 'multi-agent'],
  },
  {
  ...
  },
  {
    fieldId: 'pprofEnable',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.pprof_enable'),
    hintKey: L('sections.advanced.pprof_enable_desc'),
    yamlKeys: ['pprof', 'enable'],
    keywords: ['pprof', 'diagnostics'],
  },
  {
    fieldId: 'pprofAddr',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.pprof_addr'),
    yamlKeys: ['pprof', 'addr'],
    keywords: ['pprof', 'diagnostics'],
  },
  {
    fieldId: 'flowVisualizationEnabled',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.flow_visualization_enabled'),
    hintKey: L('sections.advanced.flow_visualization_enabled_desc'),
    yamlKeys: ['flow-visualization-enabled'],
    keywords: ['diagnostics'],
  },
  {
    fieldId: 'videoResultAuthCacheTtl',
    sectionId: 'advanced',
    labelKey: L('sections.advanced.video_result_auth_cache_ttl'),
    hintKey: L('sections.advanced.video_result_auth_cache_ttl_hint'),
